...
if __name__ == '__main__':
    root_path = r'C:/Users/robbe/Desktop/VUB/master/thesis_github/OOD.v1i.tfrecord'
    label_path = os.path.join(root_path, 'train', 'Objects_label_map.pbtxt')
    model_output_path = r'C:/Users/robbe/Desktop/VUB/master/thesis_github/Comparision/models/cnn_model.h5'

    id_to_name, name_to_id = load_label_map(label_path)
    num_classes = len(id_to_name)

    train_ds, val_ds, test_ds = prepare_datasets(root_path, name_to_id)
