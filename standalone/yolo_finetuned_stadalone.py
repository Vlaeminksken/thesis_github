...
# Yolov5 pad instellen
YOLO_PATH = os.path.abspath("yolov5")
sys.path.insert(0, YOLO_PATH)

# Patch voor veilige evaluatie
...
if __name__ == "__main__":
    ...
    weights_path = os.path.abspath(r"C:\Users\robbe\Desktop\VUB\master\thesis_github\standalone\models\yolov5m_finetuned\weights\best.pt")

    print("🚀 Evaluatie van fine-tuned model (yolov5m_finetuned) op standalone test gestart...\n")
